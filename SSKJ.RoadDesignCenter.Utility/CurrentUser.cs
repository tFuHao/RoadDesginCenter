...
namespace SSKJ.RoadDesignCenter.Utility
{
    public static class CurrentUser
    {
        ...
        {
            get => _session == null ? "" : _session.GetString("CurrentUser_UserDB");
            set => _session.SetString("CurrentUser_UserDB", !string.IsNullOrEmpty(value) ? value : "");
        }
        /// <summary>
        /// 用户数据库连接串
        /// </summary>
        ...
        {
            get => _session == null ? "" : _session.GetString("CurrentUser_UserConnectionString");
            set => _session.SetString("CurrentUser_UserConnectionString", !string.IsNullOrEmpty(value) ? value : "");
        }
