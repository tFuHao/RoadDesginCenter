...
{
    [Route("api/VerticalCurveGradeChangePoint/[action]")]
    [Area("RouteManage_RouteElement")]
    public class VerticalCurveGradeChangePointController : Controller
    {
        ...
        public VerticalCurveGradeChangePointController(IVerticalCurve_GradeChangePointBusines gradeBus, HostingEnvironment hosting)
        {
            GradeBus = gradeBus;
            Hosting = hosting;
        }
